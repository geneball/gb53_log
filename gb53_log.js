 ...
 */
export function Version(){ 	return sVersion; };
 ...
 */
export function ToggleView(){  $('#logMarkup').toggle();  }
 ...
 * @param {string} tagnm - name of log variable defined with Log.V()
 */
export function val(tagnm) {  // get value of switch set by Log, e.g. 'doExtra: do some extra stuff if true =false'
    var tag = asTag(tagnm);
    return tag.val;
}
 ...
 */
export function recordVal(tagnm, tm, val){
    var tag = asRec(tagnm);
 ...
 * @param {string} tagnm - name of log variable defined with Log.V()
 */
export function last(tagnm) {  // get time of last update
    var tg = asTag(tagnm);
    return tg.last;
}
 ...
 * @param {string} tagnm - name of log variable defined with Log.V()
 */
export function cnt(tagnm) {  // get time of last update
 ...
 */
export function Var(fmt) {  wr('V', sprintf.apply(null, arguments));  }
export function V(fmt) { Var.apply(null, arguments);; }
 ...
 */
export function VarChangedFn(s, updatefn, mthis){    // register change function, e.g. dtFmt
    var tag = wr('V', s);
    onChange(tag.nm, updatefn, mthis);
}
export function VCF(s, updatefn, mthis){ VarChangedFn(s, updatefn, mthis); }
 ...
 * @param {obj} ... - optional arguments matching fmt references
 */
export function Trace(fmt){
	if (LogDisabled) return;
	wr('T', sprintf.apply(null, arguments));
}
export function T(fmt){ Trace.apply(null, arguments); }
 ...
 * @param {obj} ... - optional arguments matching fmt references
 */
export function Watch(fmt) {
	if (LogDisabled) return;
    wr('W', sprintf.apply(null, arguments));
}
export function W(fmt){ Watch.apply(null, arguments);; }
 ...
 * @param {object} mthis -- optional this for function
 */
export function WatchFn(s, updatefn, mthis){    // register update function, e.g. WF('clock: current time', function(){
	if (LogDisabled) return;
    var tag = wr('W', s);
...
export function WF(s, updatefn, mthis){ WatchFn(s, updatefn, mthis); }
 ...
 * @param {object} mthis -- optional this for function
 */
export function CmdFn(tagnm, fn, mthis){    
	if (LogDisabled) return;
    var tag = wr('C', tagnm);
    tag.command.fn = fn;
...
export function CF(tagnm, fn, mthis){ CmdFn(tagnm, fn, mthis); }
export function CommandFn(tagnm, fn, mthis){ CmdFn(tagnm, fn, mthis); }
 ...
 */
export function valChoices(tagnm, choices){
    var tag = asTag(tagnm);
    tag.choices = choices;
}
 ...
 * @param {obj} ... - optional arguments matching fmt references
 */
export function error(fmt) {
	if (LogDisabled) return;
    wr('e', sprintf.apply(null, arguments));
}
export function e() { error.apply(null, arguments); }
 ...
 * @param {obj} ... - optional arguments matching fmt references
 */
export function warn(fmt) {
	if (LogDisabled) return;
    wr('w', sprintf.apply(null, arguments));
}
export function w() { warn.apply(null, arguments); }
export function warning() { warn.apply(null, arguments); }
...
export function i() { info.apply(null, arguments);; }
 ...
 * @param {obj} ... - optional arguments matching fmt references
 */
export function debug(fmt) {
	if (LogDisabled) return;
    wr('d', sprintf.apply(null, arguments));
}
export function d() { debug.apply(null, arguments);; }
 ...
 * @param {obj} ... - optional arguments matching fmt references
 */
export function verbose(fmt) {
	if (LogDisabled) return;
    wr('v', sprintf.apply(null, arguments));
}
export function v(fmt) { verbose.apply(null, arguments);; }
